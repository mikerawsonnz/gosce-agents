# Governance — instructor-litellm-6af681
...
```
client → https://instructor-litellm-6af681.getvda.ai/{mcp | a2a}
       → capability dispatch (instructor + litellm)
       → response
```
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/structured-output-agent-litellm
- **MCP endpoint:** https://instructor-litellm-6af681.getvda.ai/mcp
- **Agent Card:** https://instructor-litellm-6af681.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://instructor-litellm-6af681.getvda.ai/verify` (free)
