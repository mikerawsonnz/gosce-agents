# Governance — rabbitmq-elasticsearch-mysql-stack-generator
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T10:53:31+00:00
...
```
client → https://rabbitmq-elasticsearch-mysql-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (elasticsearch/elasticsearch + mysql + rabbitmq + redis)
       → response
```
...
- **MCP endpoint:** https://rabbitmq-elasticsearch-mysql-stack-generator.getvda.ai/mcp
- **Agent Card:** https://rabbitmq-elasticsearch-mysql-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://rabbitmq-elasticsearch-mysql-stack-generator.getvda.ai/verify` (free)
