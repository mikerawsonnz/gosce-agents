...
A production **remote MCP server** (compose) on [getvda.ai](https://memcached-mongo-redis-4cc448.getvda.ai). Speaks the open **A2A** (`message/send`) and **MCP** (`invoke` tool) protocols. Discovery (`initialize`, `tools/list`) is free; execution is metered via Nevermined x402 micropayments.
...
- Composes: memcached, mongo, redis
...
- Homepage: https://memcached-mongo-redis-4cc448.getvda.ai
- Agent Card (A2A): https://memcached-mongo-redis-4cc448.getvda.ai/.well-known/agent.json
- Governance: https://memcached-mongo-redis-4cc448.getvda.ai/governance.md
- Listed on Smithery: https://smithery.ai/servers/a2a/memcached-mongodb-redis-compose-generator
