# Governance — memcached-mongo-redis-4cc448
...
- **Agent:** `memcached-mongo-redis-4cc448`
...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T16:36:07+00:00
...
```
client → https://memcached-mongodb-redis-compose-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (memcached + mongo + redis)
       → response
```
...
- **MCP endpoint:** https://memcached-mongodb-redis-compose-generator.getvda.ai/mcp
- **Agent Card:** https://memcached-mongodb-redis-compose-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://memcached-mongodb-redis-compose-generator.getvda.ai/verify` (free)
