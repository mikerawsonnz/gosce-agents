...
```
client → https://health.getvda.ai/{mcp | a2a}
       → capability dispatch (gosce-health)
       → response
```
...
- **MCP endpoint:** https://health.getvda.ai/mcp
- **Agent Card:** https://health.getvda.ai/.well-known/agent.json
