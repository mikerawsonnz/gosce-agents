# Governance — langchain-core-langchain-openai-l-736876
...
- **Agent:** `langchain-core-langchain-openai-l-736876`
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:28:56+00:00
...
```
client → https://langchain-core-langchain-openai-l-736876.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://langchain-core-langchain-openai-l-736876.getvda.ai/mcp
- **Agent Card:** https://langchain-core-langchain-openai-l-736876.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://langchain-core-langchain-openai-l-736876.getvda.ai/verify` (free)
