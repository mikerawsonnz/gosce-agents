# Governance — elasticsearch-elasticsearch-kiban-19b4ad
...
- **Agent:** `elasticsearch-elasticsearch-kiban-19b4ad`
- **Combination:** `infra_elasticsearch_elasticsearch_kibana_kibana_mysql_redis` (zone `infrastructure-stacks`, system `DOCKER`)
- **Public URL:** https://elasticsearch-redis-mysql-stack-generator.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:03:43+00:00
...
```
client → https://elasticsearch-redis-mysql-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (elasticsearch/elasticsearch + kibana/kibana + mysql + redis)
       → response
```
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/elasticsearch-mysql-redis-stack-generator
- **MCP endpoint:** https://elasticsearch-redis-mysql-stack-generator.getvda.ai/mcp
- **Agent Card:** https://elasticsearch-redis-mysql-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://elasticsearch-redis-mysql-stack-generator.getvda.ai/verify` (free)
