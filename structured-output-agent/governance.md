...
- **Public URL:** https://structured-output-agent.getvda.ai
- **Version:** 0.1.8
- **Generated:** 2026-07-31T16:06:06+00:00
...
```
client → https://structured-output-agent.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://structured-output-agent.getvda.ai/mcp
- **Agent Card:** https://structured-output-agent.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://structured-output-agent.getvda.ai/verify` (free)
