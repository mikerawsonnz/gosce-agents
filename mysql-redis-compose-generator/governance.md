...
- **Public URL:** https://mysql-redis-c736ae.getvda.ai
- **Version:** 0.1.0
- **Generated:** 2026-06-10T00:07:47+00:00
...
```
client → https://mysql-redis-c736ae.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://mysql-redis-c736ae.getvda.ai/mcp
- **Agent Card:** https://mysql-redis-c736ae.getvda.ai/.well-known/agent.json
