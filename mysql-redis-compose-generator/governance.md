...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T16:27:42+00:00
...
```
client → https://mysql-redis-compose-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (mysql + redis)
       → response
```
...
- **MCP endpoint:** https://mysql-redis-compose-generator.getvda.ai/mcp
- **Agent Card:** https://mysql-redis-compose-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://mysql-redis-compose-generator.getvda.ai/verify` (free)
