...
```
client → https://llm-orchestration-agent-cryptography.getvda.ai/{mcp | a2a}
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-cryptography.getvda.ai/verify` (free)
