...
A production **remote MCP server** (langchain-llm) on [getvda.ai](https://cryptography-langchain-core-mcp-a24088.getvda.ai). Speaks the open **A2A** (`message/send`) and **MCP** (`invoke` tool) protocols. Discovery (`initialize`, `tools/list`) is free; execution is metered via Nevermined x402 micropayments.
...
- Homepage: https://cryptography-langchain-core-mcp-a24088.getvda.ai
- Agent Card (A2A): https://cryptography-langchain-core-mcp-a24088.getvda.ai/.well-known/agent.json
- Governance: https://cryptography-langchain-core-mcp-a24088.getvda.ai/governance.md
