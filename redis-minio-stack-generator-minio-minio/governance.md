...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T17:19:54+00:00
...
```
client → https://redis-minio-stack-generator-minio-minio.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://redis-minio-stack-generator-minio-minio.getvda.ai/mcp
- **Agent Card:** https://redis-minio-stack-generator-minio-minio.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://redis-minio-stack-generator-minio-minio.getvda.ai/verify` (free)
