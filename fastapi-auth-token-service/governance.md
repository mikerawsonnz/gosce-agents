# Governance — bcrypt-python-jose-1b8dd0
...
```
client → https://fastapi-auth-token-service.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://fastapi-auth-token-service.getvda.ai/mcp
- **Agent Card:** https://fastapi-auth-token-service.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://fastapi-auth-token-service.getvda.ai/verify` (free)
