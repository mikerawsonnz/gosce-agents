# Governance — confluentinc-cp-kafka-postgres-pr-60ca80
...
- **Agent:** `confluentinc-cp-kafka-postgres-pr-60ca80`
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T10:11:17+00:00
...
```
client → https://postgres-kafka-prometheus-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (confluentinc/cp-kafka + postgres + prom/prometheus)
       → response
```
...
- **MCP endpoint:** https://postgres-kafka-prometheus-stack-generator.getvda.ai/mcp
- **Agent Card:** https://postgres-kafka-prometheus-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://postgres-kafka-prometheus-stack-generator.getvda.ai/verify` (free)
