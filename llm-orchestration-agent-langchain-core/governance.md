# Governance — langchain-core-mcp-openai-29a249
...
- **Agent:** `langchain-core-mcp-openai-29a249`
- **Combination:** `ai-infrastructure_opt_006` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://llm-orchestration-agent-langchain-core.getvda.ai
- **Version:** 0.1.1
...
```
client → https://llm-orchestration-agent-langchain-core.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain-core + mcp + openai + opentelemetry-api + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-langchain-core.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-langchain-core.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-langchain-core.getvda.ai/verify` (free)
