# Governance — llm-orchestration-agent-2-df5979
...
- **Agent:** `llm-orchestration-agent-2-df5979`
- **Combination:** `ai-infrastructure_opt_042` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://llm-orchestration-agent-2-df5979.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:34:09+00:00
...
```
client → https://llm-orchestration-agent-2-df5979.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain + langchain-anthropic + langchain-openai + mcp + openai)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-2-df5979.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-2-df5979.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-2-df5979.getvda.ai/verify` (free)
