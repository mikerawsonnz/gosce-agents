# Governance — confluentinc-cp-zookeeper-postgre-48e7f1
...
- **Agent:** `confluentinc-cp-zookeeper-postgre-48e7f1`
- **Combination:** `infra_confluentinc_cp_zookeeper_postgres_prom_prometheus` (zone `infrastructure-stacks`, system `DOCKER`)
- **Public URL:** https://postgres-prometheus-stack-generator.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:25:48+00:00
...
```
client → https://postgres-prometheus-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (confluentinc/cp-zookeeper + postgres + prom/prometheus)
       → response
```
...
- **MCP endpoint:** https://postgres-prometheus-stack-generator.getvda.ai/mcp
- **Agent Card:** https://postgres-prometheus-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://postgres-prometheus-stack-generator.getvda.ai/verify` (free)
