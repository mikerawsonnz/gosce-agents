# Governance — structured-output-mcp-traced-agent
...
- **Agent:** `structured-output-mcp-traced-agent`
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:30:39+00:00
...
```
client → https://structured-output-mcp-traced-agent.getvda.ai/{mcp | a2a}
       → capability dispatch (instructor + langchain-core + mcp + openai + opentelemetry-api + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://structured-output-mcp-traced-agent.getvda.ai/mcp
- **Agent Card:** https://structured-output-mcp-traced-agent.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://structured-output-mcp-traced-agent.getvda.ai/verify` (free)
