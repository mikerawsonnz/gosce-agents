# Governance — structured-output-mcp-agent-authlib
...
- **Agent:** `structured-output-mcp-agent-authlib`
- **Combination:** `trust-identity_opt_026` (zone `trust-identity`, system `PYPI`)
- **Public URL:** https://structured-output-mcp-agent-authlib.getvda.ai
- **Version:** 0.1.0
- **Generated:** 2026-08-31T00:05:03+00:00
...
```
client → https://structured-output-mcp-agent-authlib.getvda.ai/{mcp | a2a}
       → capability dispatch (authlib + cryptography + instructor + langchain-core + mcp + openai + opentelemetry-api)
       → response
```
...
- **MCP endpoint:** https://structured-output-mcp-agent-authlib.getvda.ai/mcp
- **Agent Card:** https://structured-output-mcp-agent-authlib.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://structured-output-mcp-agent-authlib.getvda.ai/verify` (free)
