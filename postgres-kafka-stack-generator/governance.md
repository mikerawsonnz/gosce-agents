...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T11:45:38+00:00
...
```
client → https://postgres-kafka-stack-generator.getvda.ai/{mcp | a2a}
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/kafka-postgres-stack-generator
- **MCP endpoint:** https://postgres-kafka-stack-generator.getvda.ai/mcp
- **Agent Card:** https://postgres-kafka-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://postgres-kafka-stack-generator.getvda.ai/verify` (free)
