# Governance — confluentinc-cp-kafka-confluentin-83a0d7
...
- **Agent:** `confluentinc-cp-kafka-confluentin-83a0d7`
- **Combination:** `infra_confluentinc_cp_kafka_confluentinc_cp_zookeeper_postgres` (zone `infrastructure-stacks`, system `DOCKER`)
- **Public URL:** https://confluentinc-cp-kafka-confluentin-83a0d7.getvda.ai
- **Version:** 0.1.0
- **Generated:** 2026-06-19T00:04:08+00:00
...
```
client → https://confluentinc-cp-kafka-confluentin-83a0d7.getvda.ai/{mcp | a2a}
       → capability dispatch (confluentinc/cp-kafka + confluentinc/cp-zookeeper + postgres)
       → response
```
...
- **MCP endpoint:** https://confluentinc-cp-kafka-confluentin-83a0d7.getvda.ai/mcp
- **Agent Card:** https://confluentinc-cp-kafka-confluentin-83a0d7.getvda.ai/.well-known/agent.json
