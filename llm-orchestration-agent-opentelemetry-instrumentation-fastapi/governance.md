# Governance — llm-orchestration-agent-opentelemetry-instrume-a529e4
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:34:10+00:00
...
| `mcp` | agent-protocol |
| `opentelemetry-instrumentation-fastapi` | observability |
...
```
client → https://llm-orchestration-agent-opentelemetry-instrume-a529e4.getvda.ai/{mcp | a2a}
       → capability dispatch (cryptography + langchain-core + mcp + opentelemetry-instrumentation-fastapi + opentelemetry-sdk + python-jose)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-opentelemetry-instrume-a529e4.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-opentelemetry-instrume-a529e4.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-opentelemetry-instrume-a529e4.getvda.ai/verify` (free)
