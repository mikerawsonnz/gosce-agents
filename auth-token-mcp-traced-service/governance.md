# Governance — auth-token-mcp-traced-service
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:32:12+00:00
...
```
client → https://auth-token-mcp-traced-service.getvda.ai/{mcp | a2a}
       → capability dispatch (bcrypt + langchain + mcp + opentelemetry-sdk + python-jose)
       → response
```
...
- **MCP endpoint:** https://auth-token-mcp-traced-service.getvda.ai/mcp
- **Agent Card:** https://auth-token-mcp-traced-service.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://auth-token-mcp-traced-service.getvda.ai/verify` (free)
