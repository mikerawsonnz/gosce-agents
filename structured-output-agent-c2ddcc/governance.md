# Governance — groq-instructor-langchain-communi-c2ddcc
...
- **Agent:** `groq-instructor-langchain-communi-c2ddcc`
...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T20:54:25+00:00
...
```
client → https://structured-output-agent-c2ddcc.getvda.ai/{mcp | a2a}
       → capability dispatch (groq + instructor + langchain-community + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://structured-output-agent-c2ddcc.getvda.ai/mcp
- **Agent Card:** https://structured-output-agent-c2ddcc.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://structured-output-agent-c2ddcc.getvda.ai/verify` (free)
