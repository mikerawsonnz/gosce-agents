...
{
  "mcpServers": {
    "authenticated-llm-agent-google-auth-oauthlib-f0143f": {
...
- Listed on Smithery: https://smithery.ai/servers/a2a/authenticated-llm-agent-google-auth-oauthlib-f0143f
