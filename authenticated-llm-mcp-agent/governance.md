# Governance — google-auth-oauthlib-langchain-la-d042fc
...
- **Agent:** `google-auth-oauthlib-langchain-la-d042fc`
...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T20:32:45+00:00
...
```
client → https://authenticated-llm-mcp-agent.getvda.ai/{mcp | a2a}
...
- **Step-by-step instructions:** `GET https://authenticated-llm-mcp-agent.getvda.ai/verify` (free)
