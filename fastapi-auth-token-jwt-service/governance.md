# Governance — fastapi-auth-token-jwt-service
...
- **Agent:** `fastapi-auth-token-jwt-service`
...
- **Version:** 0.1.0
- **Generated:** 2026-09-02T00:03:33+00:00
...
```
client → https://fastapi-auth-token-jwt-service.getvda.ai/{mcp | a2a}
       → capability dispatch (authlib + bcrypt + python-jose)
       → response
```
...
- **MCP endpoint:** https://fastapi-auth-token-jwt-service.getvda.ai/mcp
- **Agent Card:** https://fastapi-auth-token-jwt-service.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://fastapi-auth-token-jwt-service.getvda.ai/verify` (free)
