# Governance — google-auth-oauthlib-langchain-la-d46b90
...
- **Agent:** `google-auth-oauthlib-langchain-la-d46b90`
...
- **Version:** 0.1.1
- **Generated:** 2026-08-20T15:49:50+00:00
...
```
client → https://google-auth-oauthlib-langchain-la-d46b90.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://google-auth-oauthlib-langchain-la-d46b90.getvda.ai/mcp
- **Agent Card:** https://google-auth-oauthlib-langchain-la-d46b90.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://google-auth-oauthlib-langchain-la-d46b90.getvda.ai/verify` (free)
