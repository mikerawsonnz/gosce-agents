# Governance — langchain-core-langchain-openai-l-d2feb0
...
- **Agent:** `langchain-core-langchain-openai-l-d2feb0`
- **Combination:** `ai-infrastructure_opt_026` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://llm-orchestration-agent-d2feb0.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-07-31T18:03:12+00:00
...
```
client → https://llm-orchestration-agent-d2feb0.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain-core + langchain-openai + langsmith + openai)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-d2feb0.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-d2feb0.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-d2feb0.getvda.ai/verify` (free)
