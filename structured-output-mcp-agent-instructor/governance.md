# Governance — structured-output-mcp-agent-instructor
...
- **Agent:** `structured-output-mcp-agent-instructor`
- **Combination:** `trust-identity_opt_032` (zone `trust-identity`, system `PYPI`)
- **Public URL:** https://structured-output-mcp-agent-instructor.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-09-02T10:55:26+00:00
...
```
client → https://structured-output-mcp-agent-instructor.getvda.ai/{mcp | a2a}
       → capability dispatch (instructor + langchain-core + mcp + openai + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://structured-output-mcp-agent-instructor.getvda.ai/mcp
- **Agent Card:** https://structured-output-mcp-agent-instructor.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://structured-output-mcp-agent-instructor.getvda.ai/verify` (free)
