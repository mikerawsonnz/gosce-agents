# Governance — bcrypt-langchain-core-mcp-25b8f1
...
- **Agent:** `bcrypt-langchain-core-mcp-25b8f1`
- **Combination:** `trust-identity_opt_033` (zone `trust-identity`, system `PYPI`)
- **Public URL:** https://bcrypt-langchain-core-mcp-25b8f1.getvda.ai
- **Version:** 0.1.7
- **Generated:** 2026-06-01T18:23:19+00:00
...
```
client → https://bcrypt-langchain-core-mcp-25b8f1.getvda.ai/{mcp | a2a}
       → capability dispatch (bcrypt + langchain-core + mcp + openai + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://bcrypt-langchain-core-mcp-25b8f1.getvda.ai/mcp
- **Agent Card:** https://bcrypt-langchain-core-mcp-25b8f1.getvda.ai/.well-known/agent.json
