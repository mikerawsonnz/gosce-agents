...
- **Public URL:** https://kafka-redis-minio-stack-generator.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:26:51+00:00
...
```
client → https://kafka-redis-minio-stack-generator.getvda.ai/{mcp | a2a}
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/kafka-minio-redis-stack-generator-confluentinc-cp-kafka
- **MCP endpoint:** https://kafka-redis-minio-stack-generator.getvda.ai/mcp
- **Agent Card:** https://kafka-redis-minio-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://kafka-redis-minio-stack-generator.getvda.ai/verify` (free)
