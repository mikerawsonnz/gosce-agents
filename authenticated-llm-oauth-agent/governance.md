...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T17:36:45+00:00
...
```
client → https://authenticated-llm-oauth-agent.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://authenticated-llm-oauth-agent.getvda.ai/mcp
- **Agent Card:** https://authenticated-llm-oauth-agent.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://authenticated-llm-oauth-agent.getvda.ai/verify` (free)
