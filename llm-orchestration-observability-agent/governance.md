# Governance — langchain-langchain-community-lan-6e24db
...
- **Agent:** `langchain-langchain-community-lan-6e24db`
...
```
client → https://llm-orchestration-observability-agent.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain + langchain-community + langchain-core + langchain-openai + langsmith + openai)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-observability-agent.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-observability-agent.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-observability-agent.getvda.ai/verify` (free)
