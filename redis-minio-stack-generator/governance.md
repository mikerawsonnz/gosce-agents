# Governance — confluentinc-cp-zookeeper-minio-m-545495
...
- **Agent:** `confluentinc-cp-zookeeper-minio-m-545495`
- **Combination:** `infra_confluentinc_cp_zookeeper_minio_minio_redis` (zone `infrastructure-stacks`, system `DOCKER`)
- **Public URL:** https://redis-minio-stack-generator.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-07-31T17:09:03+00:00
...
```
client → https://redis-minio-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (confluentinc/cp-zookeeper + minio/minio + redis)
       → response
```
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/minio-redis-stack-generator
- **MCP endpoint:** https://redis-minio-stack-generator.getvda.ai/mcp
- **Agent Card:** https://redis-minio-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://redis-minio-stack-generator.getvda.ai/verify` (free)
