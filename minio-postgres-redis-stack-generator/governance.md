# Governance — minio-mc-minio-minio-postgres-c93202
...
- **Agent:** `minio-mc-minio-minio-postgres-c93202`
...
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:27:44+00:00
...
```
client → https://minio-postgres-redis-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (minio/mc + minio/minio + postgres + redis)
       → response
```
...
- **MCP endpoint:** https://minio-postgres-redis-stack-generator.getvda.ai/mcp
- **Agent Card:** https://minio-postgres-redis-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://minio-postgres-redis-stack-generator.getvda.ai/verify` (free)
