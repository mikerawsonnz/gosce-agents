# Governance — langchain-core-langgraph-mcp-280d80
...
- **Agent:** `langchain-core-langgraph-mcp-280d80`
- **Combination:** `ai-infrastructure_opt_048` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://llm-orchestration-agent-langgraph.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:35:32+00:00
...
```
client → https://llm-orchestration-agent-langgraph.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain-core + langgraph + mcp + openai)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-langgraph.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-langgraph.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-langgraph.getvda.ai/verify` (free)
