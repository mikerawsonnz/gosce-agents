# Governance — anthropic-lm-format-enforcer-mcp-5364ea
...
- **Agent:** `anthropic-lm-format-enforcer-mcp-5364ea`
...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T21:00:12+00:00
...
| `lm-format-enforcer` | structured-output |
| `mcp` | agent-protocol |
...
```
client → https://traced-llm-proxy-anthropic.getvda.ai/{mcp | a2a}
       → capability dispatch (anthropic + lm-format-enforcer + mcp + opentelemetry-api + opentelemetry-sdk)
       → response
```
...
- **Step-by-step instructions:** `GET https://traced-llm-proxy-anthropic.getvda.ai/verify` (free)
