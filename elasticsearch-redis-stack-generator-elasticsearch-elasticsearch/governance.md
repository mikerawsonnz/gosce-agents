# Governance — elasticsearch-redis-stack-generator-elasticsea-588e3e
...
- **Agent:** `elasticsearch-redis-stack-generator-elasticsea-588e3e`
...
- **Version:** 0.1.0
- **Generated:** 2026-08-01T09:51:43+00:00
...
```
client → https://elasticsearch-redis-stack-generator-elasticsea-588e3e.getvda.ai/{mcp | a2a}
       → capability dispatch (elasticsearch/elasticsearch + redis)
       → response
```
...
- **MCP endpoint:** https://elasticsearch-redis-stack-generator-elasticsea-588e3e.getvda.ai/mcp
- **Agent Card:** https://elasticsearch-redis-stack-generator-elasticsea-588e3e.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://elasticsearch-redis-stack-generator-elasticsea-588e3e.getvda.ai/verify` (free)
