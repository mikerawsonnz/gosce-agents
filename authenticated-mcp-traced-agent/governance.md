...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T17:33:28+00:00
...
```
client → https://authenticated-mcp-traced-agent.getvda.ai/{mcp | a2a}
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/authenticated-mcp-agent-027cf2
...
- **Step-by-step instructions:** `GET https://authenticated-mcp-traced-agent.getvda.ai/verify` (free)
