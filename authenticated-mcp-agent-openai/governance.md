# Governance — bcrypt-langchain-core-mcp-6c9b9c
...
- **Agent:** `bcrypt-langchain-core-mcp-6c9b9c`
...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T20:03:41+00:00
...
```
client → https://authenticated-mcp-agent-openai.getvda.ai/{mcp | a2a}
       → capability dispatch (bcrypt + langchain-core + mcp + openai + opentelemetry-api + opentelemetry-sdk)
       → response
```
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/authenticated-mcp-agent-6c9b9c
- **MCP endpoint:** https://authenticated-mcp-agent-openai.getvda.ai/mcp
- **Agent Card:** https://authenticated-mcp-agent-openai.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://authenticated-mcp-agent-openai.getvda.ai/verify` (free)
