# Governance — structured-output-agent-89bcb0
...
- **Agent:** `structured-output-agent-89bcb0`
...
- **Version:** 0.1.0
- **Generated:** 2026-08-05T00:06:13+00:00
...
```
client → https://structured-output-agent-89bcb0.getvda.ai/{mcp | a2a}
       → capability dispatch (anthropic + instructor)
       → response
```
...
- **Step-by-step instructions:** `GET https://structured-output-agent-89bcb0.getvda.ai/verify` (free)
