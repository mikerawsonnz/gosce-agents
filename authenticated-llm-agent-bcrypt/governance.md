# Governance — bcrypt-langchain-openai-mcp-077256
...
- **Agent:** `bcrypt-langchain-openai-mcp-077256`
...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T17:53:23+00:00
...
```
client → https://authenticated-llm-agent-bcrypt.getvda.ai/{mcp | a2a}
       → capability dispatch (bcrypt + langchain-openai + mcp + openai + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://authenticated-llm-agent-bcrypt.getvda.ai/mcp
- **Agent Card:** https://authenticated-llm-agent-bcrypt.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://authenticated-llm-agent-bcrypt.getvda.ai/verify` (free)
