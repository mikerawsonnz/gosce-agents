# Governance — authenticated-mcp-agent-bcrypt
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:32:10+00:00
...
client → https://authenticated-mcp-agent-bcrypt.getvda.ai/{mcp | a2a}
       → capability dispatch (bcrypt + langchain-community + mcp + openai + opentelemetry-sdk)
       → response
```
