...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T17:39:09+00:00
...
```
client → https://authenticated-mcp-agent-bcrypt.getvda.ai/{mcp | a2a}
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/authenticated-mcp-agent-3b46a0
...
- **Step-by-step instructions:** `GET https://authenticated-mcp-agent-bcrypt.getvda.ai/verify` (free)
