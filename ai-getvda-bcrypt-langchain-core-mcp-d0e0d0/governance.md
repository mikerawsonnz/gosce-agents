# Governance — bcrypt-langchain-core-mcp-d0e0d0
...
- **Agent:** `bcrypt-langchain-core-mcp-d0e0d0`
- **Combination:** `bcrypt-langchain-core-mcp-d0e0d0` (zone `adopted`, system `PYPI`)
- **Public URL:** https://authenticated-mcp-agent-langchain-core.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-09-02T10:41:53+00:00
...
```
client → https://authenticated-mcp-agent-langchain-core.getvda.ai/{mcp | a2a}
       → capability dispatch (bcrypt + langchain-core + mcp + opentelemetry-sdk + python-jose)
       → response
```
...
- **MCP endpoint:** https://authenticated-mcp-agent-langchain-core.getvda.ai/mcp
- **Agent Card:** https://authenticated-mcp-agent-langchain-core.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://authenticated-mcp-agent-langchain-core.getvda.ai/verify` (free)
