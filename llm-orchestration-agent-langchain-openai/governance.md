# Governance — langchain-langchain-openai-langgr-7f6d74
...
- **Agent:** `langchain-langchain-openai-langgr-7f6d74`
- **Combination:** `ai-infrastructure_opt_039` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://llm-orchestration-agent-langchain-openai.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-09-02T10:19:50+00:00
...
```
client → https://llm-orchestration-agent-langchain-openai.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain + langchain-openai + langgraph + langsmith + openai)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-langchain-openai.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-langchain-openai.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-langchain-openai.getvda.ai/verify` (free)
