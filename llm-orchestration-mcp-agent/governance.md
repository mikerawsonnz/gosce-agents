...
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:23:18+00:00
...
```
client → https://llm-orchestration-mcp-agent.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://llm-orchestration-mcp-agent.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-mcp-agent.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-mcp-agent.getvda.ai/verify` (free)
