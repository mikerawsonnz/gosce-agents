# Governance — cryptography-google-auth-oauthlib-29bc28
...
- **Agent:** `cryptography-google-auth-oauthlib-29bc28`
- **Combination:** `ai-infrastructure_opt_001` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://cryptography-google-auth-oauthlib-29bc28.getvda.ai
- **Version:** 0.1.0
- **Generated:** 2026-06-09T00:03:15+00:00
...
```
client → https://cryptography-google-auth-oauthlib-29bc28.getvda.ai/{mcp | a2a}
       → capability dispatch (cryptography + google-auth-oauthlib + langchain-openai + mcp + openai + opentelemetry-api + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://cryptography-google-auth-oauthlib-29bc28.getvda.ai/mcp
- **Agent Card:** https://cryptography-google-auth-oauthlib-29bc28.getvda.ai/.well-known/agent.json
