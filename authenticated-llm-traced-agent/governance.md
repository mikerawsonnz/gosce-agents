...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T11:42:15+00:00
...
```
client → https://authenticated-llm-traced-agent.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://authenticated-llm-traced-agent.getvda.ai/mcp
- **Agent Card:** https://authenticated-llm-traced-agent.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://authenticated-llm-traced-agent.getvda.ai/verify` (free)
