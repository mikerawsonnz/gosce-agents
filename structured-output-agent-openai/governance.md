# Governance — structured-output-agent-openai
...
- **Agent:** `structured-output-agent-openai`
...
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:41:11+00:00
...
```
client → https://structured-output-agent-openai.getvda.ai/{mcp | a2a}
       → capability dispatch (instructor + openai)
       → response
```
...
- **MCP endpoint:** https://structured-output-agent-openai.getvda.ai/mcp
- **Agent Card:** https://structured-output-agent-openai.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://structured-output-agent-openai.getvda.ai/verify` (free)
