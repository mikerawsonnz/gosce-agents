# Governance — traced-llm-mcp-proxy
...
```
client → https://traced-llm-mcp-proxy.getvda.ai/{mcp | a2a}
       → capability dispatch (anthropic + mcp + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://traced-llm-mcp-proxy.getvda.ai/mcp
- **Agent Card:** https://traced-llm-mcp-proxy.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://traced-llm-mcp-proxy.getvda.ai/verify` (free)
