# Governance — structured-output-mcp-agent-cryptography
...
- **Agent:** `structured-output-mcp-agent-cryptography`
...
- **Version:** 0.1.0
- **Generated:** 2026-09-01T00:04:47+00:00
...
```
client → https://structured-output-mcp-agent-cryptography.getvda.ai/{mcp | a2a}
       → capability dispatch (authlib + cryptography + instructor + langchain-core + mcp + openai + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://structured-output-mcp-agent-cryptography.getvda.ai/mcp
- **Agent Card:** https://structured-output-mcp-agent-cryptography.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://structured-output-mcp-agent-cryptography.getvda.ai/verify` (free)
