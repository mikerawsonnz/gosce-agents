# Governance — anthropic-google-auth-oauthlib-mc-aed9d5
...
- **Agent:** `anthropic-google-auth-oauthlib-mc-aed9d5`
...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T18:15:50+00:00
...
```
client → https://authenticated-llm-agent-anthropic.getvda.ai/{mcp | a2a}
       → capability dispatch (anthropic + google-auth-oauthlib + mcp)
       → response
```
...
- **MCP endpoint:** https://authenticated-llm-agent-anthropic.getvda.ai/mcp
- **Agent Card:** https://authenticated-llm-agent-anthropic.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://authenticated-llm-agent-anthropic.getvda.ai/verify` (free)
