# Governance — rabbitmq-elasticsearch-postgres-stack-generato-053bcf
...
- **Agent:** `rabbitmq-elasticsearch-postgres-stack-generato-053bcf`
- **Combination:** `infra_elasticsearch_elasticsearch_postgres_rabbitmq_redis` (zone `infrastructure-stacks`, system `DOCKER`)
- **Public URL:** https://rabbitmq-elasticsearch-postgres-stack-generato-053bcf.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:44:07+00:00
...
```
client → https://rabbitmq-elasticsearch-postgres-stack-generato-053bcf.getvda.ai/{mcp | a2a}
       → capability dispatch (elasticsearch/elasticsearch + postgres + rabbitmq + redis)
       → response
```
...
- **MCP endpoint:** https://rabbitmq-elasticsearch-postgres-stack-generato-053bcf.getvda.ai/mcp
- **Agent Card:** https://rabbitmq-elasticsearch-postgres-stack-generato-053bcf.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://rabbitmq-elasticsearch-postgres-stack-generato-053bcf.getvda.ai/verify` (free)
