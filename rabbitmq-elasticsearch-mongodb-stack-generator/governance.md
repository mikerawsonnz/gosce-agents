# Governance — rabbitmq-elasticsearch-mongodb-stack-generator
...
- **Agent:** `rabbitmq-elasticsearch-mongodb-stack-generator`
- **Combination:** `infra_elasticsearch_elasticsearch_mongo_rabbitmq_redis` (zone `infrastructure-stacks`, system `DOCKER`)
- **Public URL:** https://rabbitmq-elasticsearch-mongodb-stack-generator.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:46:07+00:00
...
```
client → https://rabbitmq-elasticsearch-mongodb-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (elasticsearch/elasticsearch + mongo + rabbitmq + redis)
       → response
```
...
- **MCP endpoint:** https://rabbitmq-elasticsearch-mongodb-stack-generator.getvda.ai/mcp
- **Agent Card:** https://rabbitmq-elasticsearch-mongodb-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://rabbitmq-elasticsearch-mongodb-stack-generator.getvda.ai/verify` (free)
