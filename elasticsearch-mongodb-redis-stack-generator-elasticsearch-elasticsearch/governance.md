# Governance — elasticsearch-mongodb-redis-stack-generator-el-d8f067
...
- **Agent:** `elasticsearch-mongodb-redis-stack-generator-el-d8f067`
...
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:44:59+00:00
...
```
client → https://elasticsearch-mongodb-redis-stack-generator-el-d8f067.getvda.ai/{mcp | a2a}
       → capability dispatch (elasticsearch/elasticsearch + mongo + redis + traefik)
       → response
```
...
- **MCP endpoint:** https://elasticsearch-mongodb-redis-stack-generator-el-d8f067.getvda.ai/mcp
- **Agent Card:** https://elasticsearch-mongodb-redis-stack-generator-el-d8f067.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://elasticsearch-mongodb-redis-stack-generator-el-d8f067.getvda.ai/verify` (free)
