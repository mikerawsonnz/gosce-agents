# Governance — postgres-redis-10a16c
...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T16:02:32+00:00
...
```
client → https://postgres-redis-compose-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (postgres + redis)
       → response
```
...
- **MCP endpoint:** https://postgres-redis-compose-generator.getvda.ai/mcp
- **Agent Card:** https://postgres-redis-compose-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://postgres-redis-compose-generator.getvda.ai/verify` (free)
