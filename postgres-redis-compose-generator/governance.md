...
- **Public URL:** https://postgres-redis-10a16c.getvda.ai
- **Version:** 0.1.0
- **Generated:** 2026-06-08T06:56:38+00:00
...
```
client → https://postgres-redis-10a16c.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://postgres-redis-10a16c.getvda.ai/mcp
- **Agent Card:** https://postgres-redis-10a16c.getvda.ai/.well-known/agent.json
