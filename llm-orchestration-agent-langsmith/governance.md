# Governance — langchain-langchain-core-langchai-66fa5c
...
- **Agent:** `langchain-langchain-core-langchai-66fa5c`
- **Combination:** `ai-infrastructure_opt_047` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://llm-orchestration-agent-langsmith.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:34:47+00:00
...
```
client → https://llm-orchestration-agent-langsmith.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain + langchain-core + langchain-openai + langsmith + openai)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-langsmith.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-langsmith.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-langsmith.getvda.ai/verify` (free)
