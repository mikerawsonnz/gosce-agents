...
- **Public URL:** https://minio-minio-postgres-redis-f309ea.getvda.ai
- **Version:** 0.1.0
- **Generated:** 2026-06-24T00:08:54+00:00
...
```
client → https://minio-minio-postgres-redis-f309ea.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://minio-minio-postgres-redis-f309ea.getvda.ai/mcp
- **Agent Card:** https://minio-minio-postgres-redis-f309ea.getvda.ai/.well-known/agent.json
