# Governance — minio-minio-postgres-redis-f309ea
...
- **Agent:** `minio-minio-postgres-redis-f309ea`
- **Combination:** `infra_minio_minio_postgres_redis` (zone `infrastructure-stacks`, system `DOCKER`)
- **Public URL:** https://redis-minio-postgres-stack-generator.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-07-31T17:14:20+00:00
...
```
client → https://redis-minio-postgres-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (minio/minio + postgres + redis)
       → response
```
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/minio-postgres-redis-stack-generator-minio-minio
- **MCP endpoint:** https://redis-minio-postgres-stack-generator.getvda.ai/mcp
- **Agent Card:** https://redis-minio-postgres-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://redis-minio-postgres-stack-generator.getvda.ai/verify` (free)
