# Governance — llm-orchestration-agent-d0a1a1
...
- **Agent:** `llm-orchestration-agent-d0a1a1`
...
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:48:34+00:00
...
```
client → https://llm-orchestration-agent-d0a1a1.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain-mcp-adapters + langchain-openai + mcp + openai)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-d0a1a1.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-d0a1a1.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-d0a1a1.getvda.ai/verify` (free)
