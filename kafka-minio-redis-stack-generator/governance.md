...
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:24:57+00:00
...
```
client → https://kafka-minio-redis-stack-generator.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://kafka-minio-redis-stack-generator.getvda.ai/mcp
- **Agent Card:** https://kafka-minio-redis-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://kafka-minio-redis-stack-generator.getvda.ai/verify` (free)
