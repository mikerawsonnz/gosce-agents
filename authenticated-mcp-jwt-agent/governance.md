# Governance — bcrypt-langchain-core-mcp-97246c
...
- **Agent:** `bcrypt-langchain-core-mcp-97246c`
- **Combination:** `ai-infrastructure_opt_029` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://bcrypt-langchain-core-mcp-97246c.getvda.ai
- **Version:** 0.1.0
- **Generated:** 2026-06-30T00:05:47+00:00
...
```
client → https://bcrypt-langchain-core-mcp-97246c.getvda.ai/{mcp | a2a}
       → capability dispatch (bcrypt + langchain-core + mcp + openai + python-jose)
       → response
```
...
- **MCP endpoint:** https://bcrypt-langchain-core-mcp-97246c.getvda.ai/mcp
- **Agent Card:** https://bcrypt-langchain-core-mcp-97246c.getvda.ai/.well-known/agent.json
