# Governance — confluentinc-cp-kafka-confluentin-01eb69
...
- **Agent:** `confluentinc-cp-kafka-confluentin-01eb69`
- **Combination:** `infra_confluentinc_cp_kafka_confluentinc_cp_zookeeper_postgres_prom_prometheus` (zone `infrastructure-stacks`, system `DOCKER`)
- **Public URL:** https://postgres-prometheus-kafka-stack-generator.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:26:33+00:00
...
```
client → https://postgres-prometheus-kafka-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (confluentinc/cp-kafka + confluentinc/cp-zookeeper + postgres + prom/prometheus)
       → response
```
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/kafka-postgres-prometheus-stack-generator
- **MCP endpoint:** https://postgres-prometheus-kafka-stack-generator.getvda.ai/mcp
- **Agent Card:** https://postgres-prometheus-kafka-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://postgres-prometheus-kafka-stack-generator.getvda.ai/verify` (free)
