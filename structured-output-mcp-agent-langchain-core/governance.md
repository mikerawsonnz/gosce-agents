# Governance — structured-output-mcp-agent-langchain-core
...
- **Agent:** `structured-output-mcp-agent-langchain-core`
...
- **Version:** 0.1.0
- **Generated:** 2026-08-12T00:04:26+00:00
...
```
client → https://structured-output-mcp-agent-langchain-core.getvda.ai/{mcp | a2a}
       → capability dispatch (instructor + langchain-core + mcp + openai + opentelemetry-api)
       → response
```
...
- **Step-by-step instructions:** `GET https://structured-output-mcp-agent-langchain-core.getvda.ai/verify` (free)
