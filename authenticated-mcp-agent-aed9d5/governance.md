# Governance — authenticated-mcp-agent-aed9d5
...
- **Agent:** `authenticated-mcp-agent-aed9d5`
...
- **Version:** 0.1.0
- **Generated:** 2026-08-13T00:05:20+00:00
...
```
client → https://authenticated-mcp-agent-aed9d5.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://authenticated-mcp-agent-aed9d5.getvda.ai/mcp
- **Agent Card:** https://authenticated-mcp-agent-aed9d5.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://authenticated-mcp-agent-aed9d5.getvda.ai/verify` (free)
