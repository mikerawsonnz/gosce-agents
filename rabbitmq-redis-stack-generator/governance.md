# Governance — rabbitmq-redis-e257b7
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T11:49:49+00:00
...
```
client → https://rabbitmq-redis-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (rabbitmq + redis)
       → response
```
...
- **MCP endpoint:** https://rabbitmq-redis-stack-generator.getvda.ai/mcp
- **Agent Card:** https://rabbitmq-redis-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://rabbitmq-redis-stack-generator.getvda.ai/verify` (free)
