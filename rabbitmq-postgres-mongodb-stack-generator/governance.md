# Governance — rabbitmq-postgres-mongodb-stack-generator
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:13:11+00:00
...
```
client → https://rabbitmq-postgres-mongodb-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (mongo + postgres + rabbitmq + redis)
       → response
```
...
- **MCP endpoint:** https://rabbitmq-postgres-mongodb-stack-generator.getvda.ai/mcp
- **Agent Card:** https://rabbitmq-postgres-mongodb-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://rabbitmq-postgres-mongodb-stack-generator.getvda.ai/verify` (free)
