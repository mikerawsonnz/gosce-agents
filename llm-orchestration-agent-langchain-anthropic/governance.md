# Governance — langchain-anthropic-langchain-com-f78c82
...
- **Agent:** `langchain-anthropic-langchain-com-f78c82`
- **Combination:** `ai-infrastructure_opt_053` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://llm-orchestration-agent-langchain-anthropic.getvda.ai
- **Version:** 0.1.2
- **Generated:** 2026-09-02T10:17:58+00:00
...
```
client → https://llm-orchestration-agent-langchain-anthropic.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain-anthropic + langchain-community + langchain-openai + openai)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-langchain-anthropic.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-langchain-anthropic.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-langchain-anthropic.getvda.ai/verify` (free)
