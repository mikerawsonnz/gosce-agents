# Governance — llm-orchestration-agent-opentelemetry-api
...
- **Agent:** `llm-orchestration-agent-opentelemetry-api`
- **Combination:** `ai-infrastructure_opt_003` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://llm-orchestration-agent-opentelemetry-api.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:18:05+00:00
...
```
client → https://llm-orchestration-agent-opentelemetry-api.getvda.ai/{mcp | a2a}
       → capability dispatch (cryptography + langchain-openai + mcp + openai + opentelemetry-api + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-opentelemetry-api.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-opentelemetry-api.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-opentelemetry-api.getvda.ai/verify` (free)
