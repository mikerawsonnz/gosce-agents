...
A production **remote MCP server** (compose) on [getvda.ai](https://adminer-mysql-redis-a79723.getvda.ai). Speaks the open **A2A** (`message/send`) and **MCP** (`invoke` tool) protocols. Discovery (`initialize`, `tools/list`) is free; execution is metered via Nevermined x402 micropayments.
...
- Homepage: https://adminer-mysql-redis-a79723.getvda.ai
- Agent Card (A2A): https://adminer-mysql-redis-a79723.getvda.ai/.well-known/agent.json
- Governance: https://adminer-mysql-redis-a79723.getvda.ai/governance.md
- Listed on Smithery: https://smithery.ai/servers/a2a/mysql-redis-compose-generator-adminer
