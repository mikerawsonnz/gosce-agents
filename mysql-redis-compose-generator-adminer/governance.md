# Governance — adminer-mysql-redis-a79723
...
- **Agent:** `adminer-mysql-redis-a79723`
- **Combination:** `infra_adminer_mysql_redis` (zone `infrastructure-stacks`, system `DOCKER`)
- **Public URL:** https://mysql-redis-compose-generator-adminer.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:21:15+00:00
...
```
client → https://mysql-redis-compose-generator-adminer.getvda.ai/{mcp | a2a}
       → capability dispatch (adminer + mysql + redis)
       → response
```
...
- **MCP endpoint:** https://mysql-redis-compose-generator-adminer.getvda.ai/mcp
- **Agent Card:** https://mysql-redis-compose-generator-adminer.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://mysql-redis-compose-generator-adminer.getvda.ai/verify` (free)
