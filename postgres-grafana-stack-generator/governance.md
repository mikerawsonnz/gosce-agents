...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T11:50:22+00:00
...
```
client → https://postgres-grafana-stack-generator.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://postgres-grafana-stack-generator.getvda.ai/mcp
- **Agent Card:** https://postgres-grafana-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://postgres-grafana-stack-generator.getvda.ai/verify` (free)
