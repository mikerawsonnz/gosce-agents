# Governance — cryptography-langchain-core-mcp-22c862
...
- **Agent:** `cryptography-langchain-core-mcp-22c862`
- **Combination:** `trust-identity_opt_009` (zone `trust-identity`, system `PYPI`)
- **Public URL:** https://cryptography-langchain-core-mcp-22c862.getvda.ai
- **Version:** 0.1.0
- **Generated:** 2026-06-12T00:04:42+00:00
...
```
client → https://cryptography-langchain-core-mcp-22c862.getvda.ai/{mcp | a2a}
       → capability dispatch (cryptography + langchain-core + mcp + opentelemetry-api + opentelemetry-sdk + python-jose)
       → response
```
...
- **MCP endpoint:** https://cryptography-langchain-core-mcp-22c862.getvda.ai/mcp
- **Agent Card:** https://cryptography-langchain-core-mcp-22c862.getvda.ai/.well-known/agent.json
