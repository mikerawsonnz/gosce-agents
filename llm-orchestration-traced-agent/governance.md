...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T16:32:32+00:00
...
```
client → https://llm-orchestration-traced-agent.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://llm-orchestration-traced-agent.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-traced-agent.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-traced-agent.getvda.ai/verify` (free)
