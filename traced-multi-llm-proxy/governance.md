# Governance — traced-multi-llm-proxy
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:32:00+00:00
...
```
client → https://traced-multi-llm-proxy.getvda.ai/{mcp | a2a}
       → capability dispatch (anthropic + cryptography + langchain-openai + mcp + opentelemetry-api + opentelemetry-sdk)
       → response
```
...
- **MCP endpoint:** https://traced-multi-llm-proxy.getvda.ai/mcp
- **Agent Card:** https://traced-multi-llm-proxy.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://traced-multi-llm-proxy.getvda.ai/verify` (free)
