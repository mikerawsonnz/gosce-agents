# Governance — langchain-langchain-core-langsmit-d042fc
...
- **Agent:** `langchain-langchain-core-langsmit-d042fc`
...
- **Version:** 0.1.1
- **Generated:** 2026-09-02T12:30:27+00:00
...
```
client → https://langchain-langchain-core-langsmit-d042fc.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain + langchain-core + langsmith + openai)
       → response
```
...
- **MCP endpoint:** https://langchain-langchain-core-langsmit-d042fc.getvda.ai/mcp
- **Agent Card:** https://langchain-langchain-core-langsmit-d042fc.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://langchain-langchain-core-langsmit-d042fc.getvda.ai/verify` (free)
