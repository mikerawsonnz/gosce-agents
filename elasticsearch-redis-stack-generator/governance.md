# Governance — elasticsearch-elasticsearch-kiban-c05def
...
- **Agent:** `elasticsearch-elasticsearch-kiban-c05def`
...
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:40:25+00:00
...
```
client → https://elasticsearch-redis-stack-generator.getvda.ai/{mcp | a2a}
       → capability dispatch (elasticsearch/elasticsearch + kibana/kibana + redis)
       → response
```
...
- **MCP endpoint:** https://elasticsearch-redis-stack-generator.getvda.ai/mcp
- **Agent Card:** https://elasticsearch-redis-stack-generator.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://elasticsearch-redis-stack-generator.getvda.ai/verify` (free)
