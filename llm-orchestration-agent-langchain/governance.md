# Governance — langchain-langchain-openai-langgr-ae01b8
...
- **Agent:** `langchain-langchain-openai-langgr-ae01b8`
- **Combination:** `ai-infrastructure_opt_037` (zone `ai-infrastructure`, system `PYPI`)
- **Public URL:** https://llm-orchestration-agent-langchain.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:31:01+00:00
...
```
client → https://llm-orchestration-agent-langchain.getvda.ai/{mcp | a2a}
       → capability dispatch (langchain + langchain-openai + langgraph + mcp + openai)
       → response
```
...
- **MCP endpoint:** https://llm-orchestration-agent-langchain.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-langchain.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-langchain.getvda.ai/verify` (free)
