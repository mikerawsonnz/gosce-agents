...
- **Public URL:** https://llm-orchestration-agent-mcp.getvda.ai
- **Version:** 0.1.1
- **Generated:** 2026-09-02T10:23:32+00:00
...
```
client → https://llm-orchestration-agent-mcp.getvda.ai/{mcp | a2a}
...
- **MCP endpoint:** https://llm-orchestration-agent-mcp.getvda.ai/mcp
- **Agent Card:** https://llm-orchestration-agent-mcp.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://llm-orchestration-agent-mcp.getvda.ai/verify` (free)
