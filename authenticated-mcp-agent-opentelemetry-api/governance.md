# Governance — bcrypt-langchain-core-mcp-dc2f7b
...
- **Agent:** `bcrypt-langchain-core-mcp-dc2f7b`
...
- **Version:** 0.1.1
- **Generated:** 2026-07-31T20:23:49+00:00
...
```
client → https://authenticated-mcp-agent-opentelemetry-api.getvda.ai/{mcp | a2a}
       → capability dispatch (bcrypt + langchain-core + mcp + openai + opentelemetry-api)
       → response
```
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/authenticated-mcp-agent-dc2f7b
- **MCP endpoint:** https://authenticated-mcp-agent-opentelemetry-api.getvda.ai/mcp
- **Agent Card:** https://authenticated-mcp-agent-opentelemetry-api.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://authenticated-mcp-agent-opentelemetry-api.getvda.ai/verify` (free)
