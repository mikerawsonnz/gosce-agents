...
- **Version:** 0.1.1
- **Generated:** 2026-08-20T14:41:09+00:00
...
```
client → https://mysql-redis-compose-generator-nginx.getvda.ai/{mcp | a2a}
...
- **Listed on Smithery:** https://smithery.ai/servers/a2a/mysql-redis-nginx-stack-generator
- **MCP endpoint:** https://mysql-redis-compose-generator-nginx.getvda.ai/mcp
- **Agent Card:** https://mysql-redis-compose-generator-nginx.getvda.ai/.well-known/agent.json
...
- **Step-by-step instructions:** `GET https://mysql-redis-compose-generator-nginx.getvda.ai/verify` (free)
